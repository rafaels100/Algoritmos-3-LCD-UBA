...
grafo g = {
          ...
          {1, vecindario{make_pair(0, 28), make_pair(2, 16), make_pair(6, 14)}},
          {2, vecindario{make_pair(1, 16), make_pair(3, 12)}},
          {3, vecindario{make_pair(2, 12), make_pair(4, 22), make_pair(6, 18)}},
          {4, vecindario{make_pair(3, 22), make_pair(5, 25), make_pair(6, 24)}},
          {5, vecindario{make_pair(0, 10), make_pair(4, 25)}},
          {6, vecindario{make_pair(1, 14), make_pair(3, 18), make_pair(4, 24)}}
          };
